...
const TIGINER_I18N = {
  tr: {
    ...
    cc_panel_caps: 'PLATFORM YETENEKLERİ',
    cc_cap_1_t: 'Otomatik keşif & topoloji',
    cc_cap_1_d: 'SNMP / LLDP / CDP tabanlı; yeni cihaz dakikalar içinde envantere düşer.',
    cc_cap_2_t: 'NetFlow / sFlow / IPFIX',
    cc_cap_2_d: 'Top-talker, application breakdown, DDoS volumetrik alarm.',
    cc_cap_3_t: 'Konfigürasyon yedekleme & diff',
    cc_cap_3_d: 'Versiyonlu, imzalı snapshot. Drift uyarısı + tek tık geri al.',
    cc_cap_4_t: 'Alarm korelasyonu & runbook',
    cc_cap_4_d: 'Storm suppression, parent-child korelasyon, otomatik aksiyon.',
    cc_cap_5_t: 'SCAP / CIS uyumluluk taraması',
    cc_cap_5_d: 'Cihaz başına geçer/kalır raporu; KVKK & ISO denetim kanıtı.',
    cc_cap_6_t: 'RBAC · SSO · Audit log',
    cc_cap_6_d: 'LDAP/AD entegrasyonu; tüm operatör eylemleri imzalı kayıtlı.',

    // Outcomes
    out_badge: 'İş Sonuçları',
    out_title: 'Ekibinizin günlük operasyonunda ölçülebilir fark',
    out_sub: 'BT yöneticileri Tiginer\'a geçtikten sonra raporladığı somut değişimler. Sayılar 250 cihaz ölçeğinde tipik POC çıktılarıdır; ortamınıza göre değişir.',
    out_1_title: 'MTTR\'ı yarıdan fazla düşürün',
    out_1_desc: 'Otomatik kök neden korelasyonu ve topoloji bağlamı sayesinde olay tespitten kapanışa kadar geçen süre kısalır. Aynı arıza için 4 farklı paneli açmak zorunda kalmazsınız.',
    out_1_tag: 'Ortalama olay süresi',
    out_2_title: 'Konsolide edilmiş araç maliyeti',
    out_2_desc: 'Ayrı SNMP, NetFlow, syslog, konfig yedekleme ve uyumluluk araçları için ödediğiniz lisanslar tek platformda toplanır. Tipik müşteride 3 ila 5 farklı aracın yerini alır.',
    out_2_tag: 'Lisans konsolidasyonu',
    out_3_title: 'Uyumluluk raporları otomatikleşir',
    out_3_desc: 'KVKK, ISO 27001 ve sektör denetimlerinde istenen kanıt setlerinin büyük çoğunluğu (yapılandırma değişiklik geçmişi, erişim logu, SCAP tarama çıktısı) tek tuşla raporlanır.',
    out_3_tag: 'Manuel iş yükü azalması',
    out_4_title: 'Bulut çıkış maliyeti, sıfır',
    out_4_desc: 'Telemetri verisi sizin veri merkezinizden çıkmaz. Aylık egress ücreti, dış API çağrı limiti veya vendor lock-in yoktur. Veri sahipliği %100 sizdedir.',
    out_4_tag: 'Aylık veri çıkış ücreti',

    // Roles
    role_badge: 'Kullanım Senaryoları',
    role_title: 'Her ekip kendi sorularına Tiginer\'da yanıt bulur',
    role_sub: 'Aynı platform, farklı görüş açıları. Operasyon, güvenlik, mimari ve finans paydaşları aynı veriden farklı kararlar üretir.',
    role_1_tag: 'NOC Mühendisi',
    role_1_title: 'Tek panelden ağın canlı durumu',
    role_1_desc: 'Sabah açılışında "her şey yeşil mi?" sorusu 5 saniyede yanıtlanır. Topoloji haritası, alarm sırası ve eşik ihlali heatmap\'i aynı ekranda.',
    role_1_p1: 'Akıllı alarm gruplama (storm suppression)',
    role_1_p2: 'Otomatik runbook tetikleme',
    role_1_p3: 'Mobil bildirim · vardiya devri notları',
    role_2_tag: 'CISO / SOC',
    role_2_title: 'Denetlenebilir, audit-ready ağ',
    role_2_desc: 'Cihazlardaki her yapılandırma değişikliği imzalı olarak saklanır. Kim, ne zaman, neyi değiştirdi sorusu denetçiye 1 ekranda gösterilir.',
    role_2_p1: 'SCAP / CIS Benchmark taraması',
    role_2_p2: 'Konfigürasyon drift uyarısı',
    role_2_p3: 'RBAC + SSO/LDAP + audit log',
    role_3_tag: 'Ağ Mimarı',
    role_3_title: 'Kapasite planlaması için gerçek veri',
    role_3_desc: '12 aylık trafik, latency ve kullanım trendleri ile bant genişliği yatırım kararını "tahmin" yerine veriyle alın. NetFlow + topology birlikte analiz edilir.',
    role_3_p1: '12 ay geriye trend & forecast',
    role_3_p2: 'Site-to-site latency haritası',
    role_3_p3: '"What-if" kapasite simülasyonu',
    role_4_tag: 'CIO / CFO',
    role_4_title: 'Tahmin edilebilir TCO',
    role_4_desc: 'Bulut faturalarındaki sürpriz çıkış ücretleri yok. Yıllık abonelik tek kalem; ölçek arttıkça lisansta volume indirimi netleşir. CapEx/OpEx modeli sizin tercihiniz.',
    role_4_p1: 'Cihaz başına şeffaf lisans',
    role_4_p2: 'Yıllık + çok yıllık sözleşme seçenekleri',
    role_4_p3: 'İade & garanti koşulları yazılı',

    // Testimonial
    quote_text: '"Daha önce ağ izleme için 3 farklı araç kullanıyorduk; alarmlar arasında bağlam kaybı yaşıyorduk. Tiginer ile tek panelden topoloji, alarm ve konfig diff\'i görünce ortalama olay çözüm süremiz hafta bazında düştü. KVKK denetimine girerken raporları tek tuşla aldık."',
    quote_name: 'BT Operasyon Müdürü',
    quote_role: 'Tier-1 Bankacılık · 320 cihaz ölçeği',

    // FAQ
    faq_badge: 'Sıkça Sorulan Sorular',
    faq_title: 'Satış görüşmesinden önce merak ettikleriniz',
    faq_sub: 'BT yöneticilerinin Tiginer hakkında en sık sorduğu sorular. Listede yanıtını bulamadığınız bir konu varsa <a href="mailto:satis@tiginer.com">satis@tiginer.com</a> adresinden bize yazın.',
    faq_q1: 'Tiginer bulut tabanlı mı yoksa on-premises mi çalışır?',
    faq_a1: 'Tiginer tamamen on-premises çalışır. Tüm telemetri ve konfigürasyon verisi kendi veri merkezinizde kalır. Bulut hizmeti, dış API çağrısı veya internet erişimi zorunluluğu yoktur. Air-gap (internetten tamamen ayrı) ortamlarda da kurulabilir; offline mirror desteği sağlanır.',
    faq_q2: 'Mevcut ağ izleme aracımızdan (PRTG, SolarWinds, Zabbix) geçiş ne kadar sürer?',
    faq_a2: 'Tipik bir 250 cihazlı ortam için Proof-of-Concept (POC) 2-3 hafta, üretim devreye alma 4-6 hafta sürer. Otomatik SNMP keşfi mevcut envanteri dakikalar içinde çıkarır; alarm kuralları ve raporlar şablon olarak taşınır. Geçiş sürecinde her iki sistem paralel çalıştırılabilir.',
    faq_q3: 'Hangi cihaz markalarını destekliyor?',
    faq_a3: 'SNMP v1/v2c/v3 konuşan tüm üreticiler desteklenir: Cisco, Juniper, HP/Aruba, Huawei, Fortinet, Palo Alto, Mikrotik, F5, Arista, Dell, Ubiquiti ve daha fazlası. Vendor-specific MIB import edebilir, özel OID\'ler için custom poller tanımlayabilirsiniz. SSH ve REST API tabanlı entegrasyon da mevcuttur.',
    faq_q4: 'Lisanslama nasıl çalışır?',
    faq_a4: 'Lisanslama izlenen cihaz (node) sayısına göredir. Operatör veya panel kullanıcısı sayısı sınırsızdır. Lisans yıllık abonelik olarak verilir; destek, sürüm güncellemeleri ve güvenlik yamaları dahildir. Çok yıllık sözleşmelerde indirim uygulanır.',
    faq_q5: 'KVKK ve veri güvenliği açısından durumumuz ne olur?',
    faq_a5: 'Tiginer on-premises çalıştığı için telemetri ve loglar yurt dışına çıkmaz; veri ikametgâhı sorunu doğmaz. RBAC, audit log, SSO/LDAP/AD entegrasyonu, şifreli yedekleme ve SCAP/CIS uyumluluk denetimi yerleşiktir. KVKK & ISO 27001 denetimlerinde istenen tipik kontrol setleri ürün içinden raporlanır.',
    faq_q6: 'HA (yüksek erişilebilirlik) ve ölçeklenebilirlik desteği var mı?',
    faq_a6: 'Enterprise paketi aktif-pasif HA kümeleme, PostgreSQL replikasyon ve otomatik failover destekler. Çok siteli organizasyonlar için federated polling (uzak siteden lokal toplama, merkeze rapor) opsiyoneldir. 1000+ cihaza kadar tek instance, üzerinde shard mimari önerilir.',
    faq_q7: 'Destek nasıl sağlanıyor?',
    faq_a7: 'Türkçe ve İngilizce yerel destek ekibi sağlanır. Pro paketinde 8x5 e-posta/ticket, Enterprise paketinde 7/24 telefon + dedicated mühendis. SLA\'lı yanıt ve çözüm süreleri sözleşmede yazılı olarak tanımlanır. Çeyreklik mimari gözden geçirme toplantısı dahildir.',
    faq_q8: 'Ücretsiz deneme veya POC mümkün mü?',
    faq_a8: 'Evet. Ortamınızda sınırlı kapsamlı, başarı kriterleri önceden tanımlı 2-3 haftalık bir Proof-of-Concept kurulumu sağlıyoruz. POC sonunda performans ölçümleri ve öneriler içeren yazılı teknik rapor teslim edilir; sözleşme yükümlülüğü doğmaz.',
  },
  ...
  en: {
    ...
    cc_panel_caps: 'PLATFORM CAPABILITIES',
    cc_cap_1_t: 'Automated discovery & topology',
    cc_cap_1_d: 'SNMP / LLDP / CDP based. New devices appear in inventory within minutes.',
    cc_cap_2_t: 'NetFlow / sFlow / IPFIX',
    cc_cap_2_d: 'Top-talkers, application breakdown, DDoS volumetric alarms.',
    cc_cap_3_t: 'Config backup & diff',
    cc_cap_3_d: 'Versioned, signed snapshots. Drift alerts + one-click rollback.',
    cc_cap_4_t: 'Alarm correlation & runbook',
    cc_cap_4_d: 'Storm suppression, parent-child correlation, automated actions.',
    cc_cap_5_t: 'SCAP / CIS compliance scanning',
    cc_cap_5_d: 'Per-device pass/fail report. KVKK & ISO audit evidence.',
    cc_cap_6_t: 'RBAC · SSO · Audit log',
    cc_cap_6_d: 'LDAP/AD integration. Every operator action signed and logged.',

    // Outcomes
    out_badge: 'Business Outcomes',
    out_title: 'Measurable impact on your team\'s daily operations',
    out_sub: 'Concrete changes IT leaders report after switching to Tiginer. Numbers reflect typical POC outcomes at a 250-device scale; your environment may vary.',
    out_1_title: 'Cut MTTR by more than half',
    out_1_desc: 'Automatic root-cause correlation with topology context reduces the time from detection to closure. You don\'t open 4 different consoles for the same incident.',
    out_1_tag: 'Mean incident duration',
    out_2_title: 'Consolidated tooling cost',
    out_2_desc: 'Licenses for separate SNMP, NetFlow, syslog, config-backup and compliance tools collapse into one platform. Typically replaces 3 to 5 separate products.',
    out_2_tag: 'License consolidation',
    out_3_title: 'Automated compliance reporting',
    out_3_desc: 'Most evidence sets required by KVKK, ISO 27001 and industry audits (config change history, access logs, SCAP scan output) are reportable with a single click.',
    out_3_tag: 'Reduction in manual work',
    out_4_title: 'Zero cloud egress cost',
    out_4_desc: 'Telemetry never leaves your data center. No monthly egress fees, no external API limits, no vendor lock-in. You own 100% of the data.',
    out_4_tag: 'Monthly data egress fee',

    // Roles
    role_badge: 'Use Cases',
    role_title: 'Every team finds their own answers in Tiginer',
    role_sub: 'One platform, multiple perspectives. Operations, security, architecture and finance stakeholders make different decisions from the same data.',
    role_1_tag: 'NOC Engineer',
    role_1_title: 'Live network health, one pane',
    role_1_desc: 'Morning question "is everything green?" answered in 5 seconds. Topology map, alarm queue and threshold heatmap on the same screen.',
    role_1_p1: 'Smart alarm grouping (storm suppression)',
    role_1_p2: 'Automatic runbook triggering',
    role_1_p3: 'Mobile push · shift handover notes',
    role_2_tag: 'CISO / SOC',
    role_2_title: 'Auditable, audit-ready network',
    role_2_desc: 'Every config change on devices is stored signed. Who, when, what — answered in one screen for the auditor.',
    role_2_p1: 'SCAP / CIS Benchmark scanning',
    role_2_p2: 'Configuration drift alerts',
    role_2_p3: 'RBAC + SSO/LDAP + audit log',
    role_3_tag: 'Network Architect',
    role_3_title: 'Real data for capacity planning',
    role_3_desc: '12-month traffic, latency and usage trends turn bandwidth investment decisions from "guesswork" into data-driven choices. NetFlow + topology analyzed together.',
    role_3_p1: '12-month trend & forecast',
    role_3_p2: 'Site-to-site latency map',
    role_3_p3: '"What-if" capacity simulation',
    role_4_tag: 'CIO / CFO',
    role_4_title: 'Predictable TCO',
    role_4_desc: 'No surprise egress fees on cloud bills. Annual subscription as a single line item; volume discount scales with size. CapEx/OpEx model is your choice.',
    role_4_p1: 'Transparent per-device licensing',
    role_4_p2: 'Annual + multi-year contract options',
    role_4_p3: 'Refund & warranty terms in writing',

    // Testimonial
    quote_text: '"We were using 3 separate tools for network monitoring and losing context between alarms. With Tiginer\'s single pane for topology, alarms and config diff, our mean time-to-resolve dropped by weeks. When our KVKK audit came, we exported the evidence in one click."',
    quote_name: 'IT Operations Manager',
    quote_role: 'Tier-1 Banking · 320-device scale',

    // FAQ
    faq_badge: 'Frequently Asked Questions',
    faq_title: 'What IT leaders ask before the sales call',
    faq_sub: 'The most common questions about Tiginer. If your question isn\'t answered below, write to us at <a href="mailto:satis@tiginer.com">satis@tiginer.com</a>.',
    faq_q1: 'Is Tiginer cloud-based or on-premises?',
    faq_a1: 'Tiginer runs entirely on-premises. All telemetry and configuration data stays in your own data center. No cloud service, no outbound API calls, no internet requirement. It can be deployed in fully air-gapped environments with offline mirror support.',
    faq_q2: 'How long does migration from PRTG, SolarWinds or Zabbix take?',
    faq_a2: 'For a typical 250-device environment, the Proof-of-Concept (POC) takes 2-3 weeks and production rollout 4-6 weeks. Automatic SNMP discovery extracts existing inventory within minutes; alarm rules and reports are migrated as templates. Systems can run in parallel during migration.',
    faq_q3: 'Which device vendors are supported?',
    faq_a3: 'All vendors speaking SNMP v1/v2c/v3 are supported: Cisco, Juniper, HP/Aruba, Huawei, Fortinet, Palo Alto, Mikrotik, F5, Arista, Dell, Ubiquiti and more. Vendor-specific MIBs can be imported, and custom pollers can be defined for special OIDs. SSH and REST API integration are also available.',
    faq_q4: 'How does licensing work?',
    faq_a4: 'Licensing is based on the number of monitored devices (nodes). Operator and console user counts are unlimited. Licenses are sold as annual subscriptions including support, version upgrades and security patches. Multi-year contracts include volume discounts.',
    faq_q5: 'What about KVKK and data security?',
    faq_a5: 'Because Tiginer is on-premises, telemetry and logs never leave the country — no data residency issues. RBAC, audit log, SSO/LDAP/AD integration, encrypted backups and SCAP/CIS compliance scanning are built in. Typical control sets for KVKK & ISO 27001 audits are reportable from the product.',
    faq_q6: 'Is HA (high availability) and scaling supported?',
    faq_a6: 'The Enterprise tier supports active-passive HA clustering, PostgreSQL replication and automatic failover. For multi-site organizations, federated polling (collect locally, report centrally) is optional. Single instance scales to 1000+ devices; sharded architecture is recommended above that.',
    faq_q7: 'How is support delivered?',
    faq_a7: 'Local support is provided in Turkish and English. Pro tier: 8x5 email/ticket. Enterprise tier: 24/7 phone + dedicated engineer. SLA response and resolution times are defined in the contract. Quarterly architecture review meeting included.',
    faq_q8: 'Is a free trial or POC available?',
    faq_a8: 'Yes. We deliver a scoped, success-criteria-defined Proof-of-Concept of 2-3 weeks in your environment. The POC concludes with a written technical report including performance measurements and recommendations; no contractual obligation is created.',
  }
};
