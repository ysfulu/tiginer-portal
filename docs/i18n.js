...
const TIGINER_I18N = {
  tr: {
    ...
    why_1_desc: 'Docker tabanlı dağıtım ile sunucunuzda dakikalar içinde çalışır. Karmaşık bağımlılık yok.',
    ...
    dl_docker_title: 'Kurulum Paketi — Docker',
    dl_docker_desc: 'Docker Compose yapılandırması + kurulum scriptleri. Uygulama imajı private registry\'den otomatik indirilir.',
    dl_docker_compat: 'Windows Server 2019+, Ubuntu 22+, Debian 12+, CentOS 9+ uyumlu.',
    dl_docker_btn: 'Kurulum Paketi İndir (.zip)',
    dl_docker_hint: 'Docker Desktop veya Docker Engine gerektirir',
  ...
  en: {
    ...
    why_1_desc: 'Docker-based deployment gets you running in minutes. No complex dependencies.',
    ...
    dl_docker_title: 'Setup Package — Docker',
    dl_docker_desc: 'Docker Compose configuration + setup scripts. App image is automatically pulled from private registry.',
    dl_docker_compat: 'Compatible with Windows Server 2019+, Ubuntu 22+, Debian 12+, CentOS 9+.',
    dl_docker_btn: 'Download Setup Package (.zip)',
    dl_docker_hint: 'Requires Docker Desktop or Docker Engine',
